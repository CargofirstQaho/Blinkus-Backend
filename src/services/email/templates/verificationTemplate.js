export function verificationTemplate(otp) {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Verify your Blinkus account</title>
</head>
        ...
        <table width="100%" style="max-width:520px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e8e8e8;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              <h1 style="margin:0 0 12px;font-size:24px;font-weight:700;color:#0a0a0a;letter-spacing:-0.5px;">Verify your email</h1>
              <p style="margin:0 0 32px;font-size:15px;color:#666666;line-height:1.6;">
                Use the code below to verify your Blinkus account. This code expires in 10 minutes.
              </p>
              ...
              <p style="margin:0;font-size:13px;color:#999999;line-height:1.6;">
                If you did not create a Blinkus account, you can safely ignore this email.
              </p>
            </td>
          </tr>
          <tr>
