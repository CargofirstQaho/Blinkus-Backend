...
import { saveDraftValidator, generateValidator } from '../validators/packingListValidator.js';
import {
  saveDraft,
  getLatestDraft,
  getById,
...
router.get(   '/:id',            auditMiddleware(AUDIT_ACTIONS.PACKING_LIST_DOWNLOADED, { module: AUDIT_MODULES.PACKING_LIST, resourceType: 'PackingList' }), getById);
