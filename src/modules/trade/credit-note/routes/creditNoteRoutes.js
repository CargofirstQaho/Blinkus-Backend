...
import { saveDraftValidator, generateValidator } from '../validators/creditNoteValidator.js';
import {
  saveDraft,
  getLatestDraft,
  getById,
...
router.get(   '/:id',            auditMiddleware(AUDIT_ACTIONS.CREDIT_NOTE_DOWNLOADED, { module: AUDIT_MODULES.CREDIT_NOTE, resourceType: 'CreditNote' }), getById);
